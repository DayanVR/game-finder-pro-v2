...
export default function GamerLibraryLink() {
  return (
    <Link
      className="flex w-fit bg-(--color-bg-secondary) cursor-pointer items-center space-x-3 rounded-full border border-white/10 px-6 py-3 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:shadow-[0_0_15px_#e7000b]"
      href="/gamer-library"
    >
